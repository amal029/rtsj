...
\title{Times square -- mapping from real-time to logical-time in GALS
  and synchronous languages} % Modified by K. Kobayashi 18/06/02
...
%\boldmath
  ...
  constructs that allow use of real-time delay are illustrated on the
