...
\\ \midrule
\multirow{5}{*}{Motor} & \texttt{wait\_exactly(2.4 ms)}        & \multirow{5}{*}{1} & \multirow{5}{*}{116} \\ 
											 &
                                                                                         \texttt{wait\_exactly(1.667
                                                                                           ms)}      &                    &                      \\ 
											 &
                                                                                    \texttt{wait\_exactly(0.05
                                                                                           ms)}       &                    &                      \\ 
											 &
                                                                                    \texttt{wait\_exactly(0.3
                                                                                           ms)}        &                    &                      \\ 
											 &
                                                                                         \texttt{wait\_exactly(0.733
                                                                                           ms)}      &                    &
\\ \midrule
\multirow{3}{*}{Printer}
...
\\ \midrule
\multirow{2}{*}{AECS} & \texttt{wait\_atleast(10000 ms)} ($CD1$) 
& \multirow{2}{*}{2} & \multirow{2}{*}{267} \\
& \texttt{wait\_exactly(10000 ms)} ($CD2$) & &
\\ \bottomrule
\end{tabular}
}
\end{table}
