...
$N$ is 200.3 ms, respectively. Let the WCRT and BCRT be: 0.112 ms and
0.0334 ms, respectively. Thus, the algorithm proceeds as follows:
...
WCRT. WCRT effects the over-approximation or the period of the CD,
