...
to the original JOP design in order to collect numbers of clock cycles required for 
logical ticks of given SystemJ program. All examples except Robot are existing
