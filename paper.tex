...
{\small\textbf{Abstract--- In this paper we introduce deterministic and
    ...
    language constructs that allow use of the real-time delay are
    ...
    operation with elements of explicitly defined real-time. The
    concepts are limited to the execution platforms that allow finding
    shortest and longest periods of the logical clock of a GALS or
    synchronous program.}}
