...
%\boldmath
  ...
  language constructs that allow use of real-time delay are illustrated
  on the SystemJ GALS language. They allow system designers to
  explicitly use, at the specification level, not only logical time but
  also the real-time in order to control \hj{program execution}. The
  introduced concepts utilize execution platforms that allow finding
  best and worst \hj{execution time} of the logical clock of a GALS or
  synchronous program.
