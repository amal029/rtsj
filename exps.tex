...
in~\cite{aecs_ispa}. Motor is a stepper motor controller
...
language. The requirement to have deterministic or non-deterministic
delays varies between each benchmark. These delay requirements are shown
in Table~\ref{fig:comparison} (\texttt{M..N}).
