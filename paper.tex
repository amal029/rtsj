...
%\boldmath
	...
	\hj{program execution}. The introduced concepts utilize execution
	platforms that allow finding best and worst \hj{execution time} of the
	logical clock of a GALS or synchronous program.
