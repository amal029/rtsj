...
formal semantics, essential for the formal reasoning about \hj{code
generation} and verification of correctness of functional properties of
...
\hj{(1) real-time wait does not affect the model of logical time in
	...
	that can be determined statically by program analysis,} (2) the
...
\item We \hj{clarify} upon a key insight relating real-time and
